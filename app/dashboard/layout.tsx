    ...
    <div className={styles.dashboardContainer}>
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.nav}>
          ...
          <Link href="/dashboard/subscription" className={`${styles.navItem} ${pathname.includes('/subscription') ? styles.navItemActive : ''}`}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 4H3a2 2 0 00-2 2v12a2 2 0 002 2h18a2 2 0 002-2V6a2 2 0 00-2-2z"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
            Langganan
          </Link>
        </nav>
      </aside>
        ...
        <header className={styles.topbar}>
          <div className={styles.topbarLeft}>
            <h2 style={{ fontSize: "1.25rem", fontWeight: 600 }}>
              ...
              {pathname.includes('/subscription') && 'Paket Langganan'}
